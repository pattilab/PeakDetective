...
pathData <- "D:/PeakDetective/data/ST000992/" #path to your .mzML 
...
peakpickingParameters$min_peakwidth <- c(0.5, 5)
peakpickingParameters$max_peakwidth <- c(6,20)
peakpickingParameters$ppm <- c(15,30)
