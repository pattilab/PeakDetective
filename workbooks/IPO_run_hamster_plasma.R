...
pathData <- "D:/PeakDetective/data/hamster_plasma/polar_neg/ms1/for_ipo/" #path to your .mzML 
...
peakpickingParameters$min_peakwidth <- c(10, 30)
peakpickingParameters$max_peakwidth <- c(30,100)
